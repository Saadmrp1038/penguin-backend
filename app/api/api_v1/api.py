...
from app.api.api_v1.endpoints import query, questions, auth, protected, users, chats, issues, adminUrlTrain
...
api_router_v1.include_router(adminUrlTrain.router, prefix="/adminUrlTrain", tags=["adminUrlTrain"])